...
paths, not PDF paths. The opt-in `pdf` feature provides lower-level rendering
plumbing and requires a system Poppler installation; it does not make this
fixture an active end-to-end example.
