...
fn test_batch_empty() {
    ...
    let results = embedder.encode_batch(&empty_batch).expect("Failed to encode empty batch");
...
fn test_batch_single() {
    ...
    let batch = embedder.encode_batch(&[text]).expect("Failed to encode batch");
...
fn test_batch_same_length() {
    ...
    let batch = embedder.encode_batch(&texts).expect("Failed to encode batch");
...
fn test_batch_similarity_consistency() {
    ...
    let batch_embeddings = embedder.encode_batch(&texts).expect("Failed to encode batch");
